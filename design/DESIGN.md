...
| `sleep`     | gatekeeper offers sleep | `LOCKED` → emits `SLEEP` | Transcript ending in the offer. The "Lock the Mac" button locks immediately — the confirmation step it once opened asked the user to agree to something they had just chosen. |
